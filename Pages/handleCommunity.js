...
function HandleCommunity({route}) {
    ...
    return (
        <Tab.Navigator screenOptions={({ route }) => ({
            ...
            <Tab.Screen name="All" component={showAll} initialParams={{ extraData: user }}/>
            <Tab.Screen name="Info" component={getInfo} initialParams={{ extraData: user }}/>
            <Tab.Screen name="Campus" component={schoolLife} initialParams={{ extraData: user }}/>
            <Tab.Screen name="Friends" component={findFriend} initialParams={{ extraData: user }}/>
        </Tab.Navigator >
    )
}
