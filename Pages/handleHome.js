...
function handleHome({ route, navigation }) {
    ...
    return (
        <AllStack.Navigator>
            <AllStack.Screen name="Main" options={{ headerShown: false }} >{(props) => <HomeTabF {...props} courseName={courseName} extraData={user}/>}</AllStack.Screen>
